...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<HomeDetailBloc>().add(FetchDetail(widget.id));
    });
  }
    ...
    return Scaffold(
      body: BlocBuilder<HomeDetailBloc, HomeDetailState>(
        builder: (context, state) {
          ...
          } else if (state is HomeDetailHasData) {
...
class DetailContent extends StatelessWidget {
  ...
  const DetailContent(this.movie, this.recommendMovies, this.watchlistStatus);
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            WatchlistButton(watchlistStatus, movie: movie),
                            Text(
          ...
          return ElevatedButton(
            onPressed: () async {
              if (_watchlistStatus) {
                context
                    .read<HomeDetailBloc>()
                    .add(RemoveFromWatchlist(state, widget.movie));
                setState(() {
                ...
                context
                    .read<HomeDetailBloc>()
                    .add(AddWatchlist(state, widget.movie));
                setState(() {
