...
void main() {
  ...
  setUp(() async {
    ...
    dataSource = MovieRemoteDataSourceImpl(ioClient: fc(mockClient));
  });
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('dummy_data/now_playing.json')))
        .movieList;
    test('should return list of movie when data fetched successfully',
        () async {
      when(mockClient.get(Uri.parse('$BASE_URL/movie/now_playing?$API_KEY')))
          .thenAnswer((_) async =>
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
        () async {
      // arrange
      when(mockClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY')))
          .thenAnswer((_) async =>
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async =>
